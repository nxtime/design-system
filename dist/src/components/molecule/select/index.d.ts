...
declare const Select: <T extends TPossibleObject<T>>({ items, selected, currentSelected, selector, onChange, labelExtractor, disabled, required, showQty, style, name, position, variant, keyExtractor, }: ISelectProps<T>) => import("react/jsx-runtime").JSX.Element;
